...
Input the flowchart of chada and how to select an Octopus

## Quickstart

To build the octopus, you need to build and develop three parts: the bodyframe, the hardware, and decide on a use case for the software to flash to your device. Below, we provide you with a full list of physical components you need to build and octpus. 
...
Tools for assembling the octopus:
...
Assuming you are building an octopus will all parts included, this will be your list of hardware components: 
